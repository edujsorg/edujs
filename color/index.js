 ...
 */
function toString() {
    return createFromRGB(this.r, this.g, this.b);
}
 ...
 */
function createFromRGBL(r, g, b, l) {
 ...
 */
function average(colorOne, colorTwo) {
...
function getHexColor(hexString) {
    return hexString;
}
